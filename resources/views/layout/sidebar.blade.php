<ul class="navbar-nav  sidebar-primary text-light sidebar accordion shadow-lg" id="accordionSidebar" style="background-color: rgb(6, 103, 6)">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center text-light" href="#">
        ...
        <div class="sidebar-brand-text mx-2">WP METHOD</div>
    </a>
